...
#ifndef CGAL_GENERALIZED_MEAN_VALUE_AREA_WEIGHT_2_H
#define CGAL_GENERALIZED_MEAN_VALUE_AREA_WEIGHT_2_H
...
namespace Generalized_weights {
  ...
  /*!
    ...
    \brief 2D mean value area weight.
  ...
  */
  ...
  class Mean_value_area_weight_2 {
  ...
  public:
    ...
    */
    ...
    /*!
      \brief computes 2D mean value area weight.
    */
    const FT operator()(
      const Point_2& query,
      const Point_2& vm,
...
#endif // CGAL_GENERALIZED_MEAN_VALUE_AREA_WEIGHT_2_H
