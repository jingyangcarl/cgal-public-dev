...
public:
  typedef typename K::Collinear_3 Collinear;
  ...
  normal(normal_) {
    ...
    CGAL_PROFILER("Construct Projected_collinear_with_normal_3.")
    CGAL_TIME_PROFILER("Construct Projected_collinear_with_normal_3")
  }
  ...
  bool operator()(
    ...
    CGAL_PROFILER("Projected_collinear_with_normal_3::operator()");
    CGAL_TIME_PROFILER("Projected_collinear_with_normal_3::operator()");
...
public:
  ...
  Projected_side_of_oriented_circle_with_normal_3(
    const Vector_3& normal_) :
  normal(normal_) {
...
public:
  Projected_squared_distance_with_normal_3(
    const Vector_3& normal_) :
  normal(normal_) {
...
template<class Traits>
class Projected_squared_length_with_normal_3 {
...
public:
  typedef typename K::Compute_squared_length_3 Squared_length;
  const Squared_length squared_length;

  Projected_squared_length_with_normal_3(
    const Vector_3& normal_) :
  normal(normal_) {
    CGAL_PROFILER("Construct Projected_squared_length_with_normal_3.")
    CGAL_TIME_PROFILER("Construct Projected_squared_length_with_normal_3")
  }

  FT operator()(
    const Vector_3& v) const {

    return squared_length(v);
  }
};

template<class Traits>
class Projected_scalar_product_with_normal_3 {
...
public:
  typedef typename K::Compute_scalar_product_3 Scalar_product;

  Projected_scalar_product_with_normal_3(
    const Vector_3& normal_) :
  normal(normal_) {
    CGAL_PROFILER("Construct Projected_scalar_product_with_normal_3.")
    CGAL_TIME_PROFILER("Construct Projected_scalar_product_with_normal_3")
  }
...
public:
  ...
  Object operator()(
    ...
    if (const Line* line = object_cast<Line>(&planes_intersection)) {
      ...
      if (
        cross_product(normal, pi - s1.source()) *
        ...
        return intersection(
          *line, Plane_3(
            s1.source(),
            cross_product(s1.to_vector(), s2.to_vector())));
      }
    }
...
public:
  ...
  base1(base1),
  base2(base2) {
    CGAL_PROFILER("Construct Equal_along_axis")
    CGAL_TIME_PROFILER("Construct Equal_along_axis")
  }
...
public:
  ...
  typedef ProjectionTraitsCartesianFunctors::
  ...
  typedef ProjectionTraitsCartesianFunctors::
    Equal_along_axis<Self>                                   Equal_2;

  typedef ProjectionTraitsCartesianFunctors::
    Projected_orientation_with_normal_3<Self>                Orientation_2;

  typedef ProjectionTraitsCartesianFunctors::
    Projected_collinear_with_normal_3<Self>                  Collinear_2;
  ...
  typedef ProjectionTraitsCartesianFunctors::
    Projected_squared_length_with_normal_3<Self>             Compute_squared_length_2;

  typedef ProjectionTraitsCartesianFunctors::
    Projected_scalar_product_with_normal_3<Self>             Compute_scalar_product_2;
  ...
  compute_squared_length_2_object() const {
    return Compute_squared_length_2(this->normal());
  }

  Compute_scalar_product_2
  compute_scalar_product_2_object() const {
    return Compute_scalar_product_2(this->normal());
  }
  ...
  Construct_weighted_point_2
  construct_weighted_point_2_object() const {
  ...
  public:
    ...
    Point_2 operator()(const Point_2& point) const {
      return point + (((plane_point - point) * normal) / (normal * normal)) * normal;
    }
  };

  Projection_to_plan projection_to_plan_object(
    const Point_2& plane_point) const {
