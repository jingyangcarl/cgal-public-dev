...
using WP2 = CGAL::Generalized_weights::Wachspress_cot_weight_2<Kernel>;
...
int main() {
  ...
  // Compute weights.
  WP2 wachspress;
  std::cout << "2D wp cot: " << wachspress(query2, vm2, vj2, vp2) << std::endl;
  std::cout << "3D wp cot: " << wachspress(query3, vm3, vj3, vp3) << std::endl;
