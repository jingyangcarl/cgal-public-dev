...
#include <CGAL/Weight_interface/Generalized_weights_2/Mean_value_area_weight_2.h>
...
using MV2 = CGAL::Generalized_weights::Mean_value_area_weight_2<Kernel>;
...
int main() {
  ...
  // Compute weights.
  MV2 mean_value;
  std::cout << "2D mv area: " << mean_value(query2, vm2, vj2, vp2) << std::endl;
  std::cout << "3D mv area: " << mean_value(query3, vm3, vj3, vp3) << std::endl;
