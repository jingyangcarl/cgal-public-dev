...
using DH2 = CGAL::Generalized_weights::Discrete_harmonic_weight_2<Kernel>;
...
int main() {
  ...
  std::cout << "2D dh: " << discrete_harmonic(query2, vm2, vj2, vp2) << std::endl;
  std::cout << "3D dh: " << discrete_harmonic(query3, vm3, vj3, vp3) << std::endl;
