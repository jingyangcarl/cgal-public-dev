...
#include <CGAL/Weight_interface/Generalized_weights_2/Discrete_harmonic_cot_weight_2.h>
...
using DH2 = CGAL::Generalized_weights::Discrete_harmonic_cot_weight_2<Kernel>;
...
int main() {
  ...
  std::cout << "2D dh cot: " << discrete_harmonic(query2, vm2, vj2, vp2) << std::endl;
  std::cout << "3D dh cot: " << discrete_harmonic(query3, vm3, vj3, vp3) << std::endl;
