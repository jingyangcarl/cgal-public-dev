...
Requirements of the template parameter `GeomTraits` for all classes and functions
with 2D barycentric coordinates from the namespace `CGAL::Barycentric_coordinates`.
