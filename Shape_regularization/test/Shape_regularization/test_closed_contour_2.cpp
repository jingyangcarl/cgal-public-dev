...
int main() {
  test_closed_contour_2< CGAL::Simple_cartesian<double> >();
  test_closed_contour_2< CGAL::Exact_predicates_inexact_constructions_kernel >();
  test_closed_contour_2< CGAL::Exact_predicates_exact_constructions_kernel >();
  std::cout << "test_closed_contour_2: SUCCESS" << std::endl;
  return EXIT_SUCCESS;
}
