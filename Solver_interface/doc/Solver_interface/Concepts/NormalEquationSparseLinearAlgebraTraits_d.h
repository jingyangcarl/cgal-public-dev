...
A concept that describes the set of requirements for solving the normal equation \f$ A^t A X = A^t B \f$,
\f$ A \f$ being a matrix, \f$ A^t \f$ its transpose matrix, \f$ B \f$ and \f$ X \f$ being two vectors.
...
/*!
  Factorizes the sparse matrix `At * A`.
...
/*!
  Solves the sparse linear system `At * A * X = At * B`, with `A` being the matrix
